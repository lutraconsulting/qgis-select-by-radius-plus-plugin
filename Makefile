...
#		begin				: 2017-08-27
#		git sha				: $Format:%H$
#		copyright			: (C) 2017 by Viktor Sklencar for Lutra Consulting
...
SOURCES = \
	__init__.py \
	radius_selector_feature.py \
	radius_selector_dialog.py
	radius_selector_tool.py

PLUGINNAME = SelectByRadiusPlus
